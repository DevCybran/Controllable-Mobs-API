...
import net.minecraft.server.v1_5_R3.PathfinderGoalBeg;
import net.minecraft.server.v1_5_R3.PathfinderGoalBreakDoor;
import net.minecraft.server.v1_5_R3.PathfinderGoalBreed;
import net.minecraft.server.v1_5_R3.PathfinderGoalDefendVillage;
import net.minecraft.server.v1_5_R3.PathfinderGoalDoorInteract;
...
import net.minecraft.server.v1_5_R3.PathfinderGoalFollowOwner;
import net.minecraft.server.v1_5_R3.PathfinderGoalFollowParent;
import net.minecraft.server.v1_5_R3.PathfinderGoalHurtByTarget;
import net.minecraft.server.v1_5_R3.PathfinderGoalInteract;
import net.minecraft.server.v1_5_R3.PathfinderGoalJumpOnBlock;
import net.minecraft.server.v1_5_R3.PathfinderGoalLeapAtTarget;
import net.minecraft.server.v1_5_R3.PathfinderGoalLookAtPlayer;
import net.minecraft.server.v1_5_R3.PathfinderGoalLookAtTradingPlayer;
import net.minecraft.server.v1_5_R3.PathfinderGoalMakeLove;
import net.minecraft.server.v1_5_R3.PathfinderGoalMeleeAttack;
import net.minecraft.server.v1_5_R3.PathfinderGoalMoveIndoors;
...
import net.minecraft.server.v1_5_R3.PathfinderGoalOcelotAttack;
import net.minecraft.server.v1_5_R3.PathfinderGoalOfferFlower;
import net.minecraft.server.v1_5_R3.PathfinderGoalOpenDoor;
import net.minecraft.server.v1_5_R3.PathfinderGoalOwnerHurtByTarget;
import net.minecraft.server.v1_5_R3.PathfinderGoalOwnerHurtTarget;
...
import net.minecraft.server.v1_5_R3.PathfinderGoalPlay;
...
import net.minecraft.server.v1_5_R3.PathfinderGoalRandomTargetNonTamed;
import net.minecraft.server.v1_5_R3.PathfinderGoalRestrictOpenDoor;
...
import net.minecraft.server.v1_5_R3.PathfinderGoalTakeFlower;
import net.minecraft.server.v1_5_R3.PathfinderGoalTempt;
import net.minecraft.server.v1_5_R3.PathfinderGoalTradeWithPlayer;
